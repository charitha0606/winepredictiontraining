...
public class LogisticRegressionUtil {
    ...
    private static final String TRAINING_DATASET = "s3a://winepredictiondataset/TrainingDataset.csv";
    private static final String VALIDATION_DATASET = "s3a://winepredictiondataset/ValidationDataset.csv";
    private static final String MODEL_PATH = "s3a://winepredictiondataset/LogisticRegressionModel";
